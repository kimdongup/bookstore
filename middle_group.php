...
$numresults=mysqli_query($link,"select id from goods where fixnum='$fixnum' ");
...
<b><?php echo $name; ?></b> > 
<?php
$query=mysqli_query($link,"select id,name from goods2 where fixnum='$fixnum' ");
while ($row=mysqli_fetch_array($query)){
?>
<a href="low_group.php?name=<?php echo $name; ?>&lowname=<?php echo $row['name']; ?>&fixnum=<?php echo $fixnum; ?>&gs2id=<?php echo $row['id']; ?>">
<?php echo $row['name']; ?></a> |
<?php
}
?>	
...
<tr><td colspan="3" height="25" align="right">| <a href=<?php $_SERVER['SCRIPT_NAME']; ?>?name=<?php echo $name; ?>&lowname=<?php echo $lowname; ?>&fixnum=<?php echo $fixnum; ?>>기본순</a> | <a href=<?php $_SERVER['SCRIPT_NAME']; ?>?dbarray=nvolume&name=<?php echo $name; ?>&lowname=<?php echo $lowname; ?>&fixnum=<?php echo $fixnum; ?>>판매량</a> | <a href=<?php $_SERVER['SCRIPT_NAME']; ?>?dbarray=nnew&name=<?php echo $name; ?>&lowname=<?php echo $lowname; ?>&fixnum=<?php echo $fixnum; ?>>신상품</a> | <a href=<?php $_SERVER['SCRIPT_NAME']; ?>?dbarray=npricea&name=<?php echo $name; ?>&lowname=<?php echo $lowname; ?>&fixnum=<?php echo $fixnum; ?>>가격↑</a> | <a href=<?php $_SERVER['SCRIPT_NAME']; ?>?dbarray=npriced&name=<?php echo $name; ?>&lowname=<?php echo $lowname; ?>&fixnum=<?php echo $fixnum; ?>>가격↓</a> | <a href=<?php $_SERVER['SCRIPT_NAME']; ?>?dbarray=nname&name=<?php echo $name; ?>&lowname=<?php echo $lowname; ?>&fixnum=<?php echo $fixnum; ?>>상품명</a> |</td></tr>
<tr><td colspan="3" height="1" bgcolor="#cccccc"></td></tr>
...
if($dbarray=="nvolume"){
$query=mysqli_query($link,"select * from goods where fixnum='$fixnum' order by volume desc limit $fromnum,$limit50");
} else if($dbarray=="nnew"){
$query=mysqli_query($link,"select * from goods where fixnum='$fixnum' order by pmonth,pday desc limit $fromnum,$limit50");
} else if($dbarray=="npricea"){
$query=mysqli_query($link,"select * from goods where fixnum='$fixnum' order by price asc limit $fromnum,$limit50");
} else if($dbarray=="npriced"){
$query=mysqli_query($link,"select * from goods where fixnum='$fixnum' order by price desc limit $fromnum,$limit50");
} else if($dbarray=="nname"){
$query=mysqli_query($link,"select * from goods where fixnum='$fixnum' order by name desc limit $fromnum,$limit50");
} else {
$query=mysqli_query($link,"select * from goods where fixnum='$fixnum' order by id desc limit $fromnum,$limit50");
}
$num=1;
