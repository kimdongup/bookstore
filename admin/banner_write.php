...
function recording() {
	...
	document.Form1.action = 'banner_insert.php';
...
<input type="hidden" name="mod" value="bannerinsert">
<table align="center" border="0" cellpadding="0" cellspacing="0" width="900">
<tr>
<td width="20" height="40">
<img src="../image/green_folder.jpg" border="0">  
</td>
<td width="880"> &nbsp;<B>배너 등록</B>
</td>
</tr>
...
<table align="center" border="0" cellpadding="5" cellspacing="0" width="900">
	...
	<input type="text" name="url" value="http://" maxlength="30" style="width:500px">
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
		<tr>
			...
			<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">								
			<input type="text" name="action2" value="" maxlength="30" style="width:50px">
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
		<table align="left" border="0" cellpadding="0" cellspacing="0">
			...
			<input type="file" size="60" name="imgup1" class="input" onChange="show_pic('1','imgup1');"></font>
				...
				<td width="100">				
				<img id="pic1" width="42" height="55" src="../image/jeungm.jpg" align="absbottom" onLoad="if(this.fileSize>300000)alert('300000kbyte가 넘습니다.\n이사진은 업로드되지 않습니다.\n다시 넣어 주세요.')";>
				</td>
			</tr>
		</table>
	</td>
