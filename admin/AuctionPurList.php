...
<td width="880"> &nbsp;<B>경매 상품보기</B>(총등록수 : <?php echo number_format($numrows); ?>건)
</td>
</tr>
...
$query=mysqli_query($link,"select * from auctionpurchase order by id desc limit $fromnum,$limit50");
$i=1;
...
<td align="center" bgcolor="<?php echo $bgcolor; ?>">
<?php echo number_format($row['recordquantity']); ?>개
</td>
<td align="center" bgcolor="<?php echo $bgcolor; ?>">
...
<td align="center" bgcolor="<?php echo $bgcolor; ?>">
<a href="auctionPurModify.php?id=<?php echo $row['id'] ?>&modifyname=<?php echo $row2['name']?>&mod=auctionpurdel">수정</a> <a href="auctionPurDel.php?id=<?php echo $row['id'] ?>&delname=<?php echo $row2['name']?>&mod=auctionpurdel">삭제</a>
</td>
</tr>
<tr>
