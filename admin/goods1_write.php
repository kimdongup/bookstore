...
<table align="center" border="0" cellpadding="5" cellspacing="0" width="900">
	...
	<input type="text" name="fixid" value="" maxlength="20" style="width:122px"> 본 번호는 중분류,소분류,상품에 모두 적용됩니다.
	</td>
	</tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
	<input type="text" name="name" value="" maxlength="20" style="width:122px"> 가장 큰 분류( ex : 소설,시,에세이,컴퓨터)
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	</td>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
	<input type="text" name="number" value="1" maxlength="20" style="width:122px"> 초기화면 좌측에 출력될 순서(낮은 숫자일 수록 상위에 나타납니다.)
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	</td>
...
<div align="left">
<a href="javascript:recording();" style="padding-left:170px"><b>[대분류등록하기]</b></a>
</div>
<p>
<?php
