...
if($mod == 'synerpur'){
    $update = "update synergicpurchase set goodsid='$goodsid',fixprice='$hidf1',price='$hidf2',endprice='$hidf3',dcprice='$dcprice',recordquantity='$recordquantity',orderquantity='$orderquantity' where id=$id";
    $result=mysqli_query($link,$update);
    returnurl("SynerPurModify.php?id=".$id);
}else{
	err_msg("잘못된 접근입니다.");
	}
	}else{
