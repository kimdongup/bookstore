...
$numresults=mysqli_query($link,"select id from goods1");
...
<td width="880"> &nbsp;<B>대분류</B> <a href="goods1_write.php">[등록하기]</a>
</td>
</tr>
<tr><td colspan="5" height="2" bgcolor="#6699FF"></td></tr>
...
$query=mysqli_query($link,"select * from goods1 order by number asc limit $fromnum,$limit50");
$i=1;
