...
function recording() {
	...
	document.Form1.action = 'goods_insert.php';
...
$row=mysqli_fetch_array($result);
echo ">".$row['name'];
$result=mysqli_query($link,"select name from goods3 where id=$gs3id");
$row=mysqli_fetch_array($result);
echo ">".$row['name'];
?>	
</td>
...
<table align="center" border="0" cellpadding="5" cellspacing="0" width="900">
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
	<input type="text" name="fixid" value="<?php echo $fixid; ?>" maxlength="20" style="width:122px"> 본 번호는 중분류,소분류,상품에 모두 적용됩니다.
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
	<input type="text" name="name" value="" maxlength="50" style="width:300px"> (ex : PHP5 온라인 서점 만들기) 
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
	<input type="text" name="author" value="" maxlength="20" style="width:300px">
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
	<input type="text" name="publishing" value="" maxlength="20" style="width:300px">
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
	<input type="text" name="pyear" value="" maxlength="4" style="width:40px">년 &nbsp;
	<input type="text" name="pmonth" value="" maxlength="4" style="width:20px">월 &nbsp;
	<input type="text" name="pday" value="" maxlength="4" style="width:20px">일 
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
	<input type="text" name="epage" value="" maxlength="6" style="width:50px">
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
	<input type="text" name="isbn" value="" maxlength="30" style="width:300px">
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
	<input type=text name='dday' size="5" value='' style='text-align:right;'>일 
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	<td width="155" nowrap style="padding-left:15px" class="bgc_table2" height="55">
	<font color="red">*</font> 배송비용(국내)
	</td>
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
    <input type="radio" name="dcost" value="1" checked>있음&nbsp;&nbsp;
    <input type="radio" name="dcost" value="2">무료&nbsp;&nbsp;
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
    <input type="radio" name="dcountry" value="1" checked>국내가능&nbsp;&nbsp;
    <input type="radio" name="dcountry" value="2">해외가능&nbsp;&nbsp;
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	<td width="155" nowrap style="padding-left:15px" class="bgc_table2" height="55">
	<font color="red">*</font> 최저보상제
	</td>
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
    <input type="radio" name="lowest" value="1">실시함&nbsp;&nbsp;
    <input type="radio" name="lowest" value="2" checked>실시하지 않음&nbsp;&nbsp;
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
    <input type="radio" name="gsnew" value="1">신상품으로 등록함&nbsp;&nbsp;
    <input type="radio" name="gsnew" value="2" checked>신상품으로 등록하지 않음&nbsp;&nbsp;
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
    <input type="radio" name="best" value="1">베스트셀러로 등록함 &nbsp;&nbsp;
    <input type="radio" name="best" value="2" checked>베스트셀러로 등록하지 않음&nbsp;&nbsp;
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
    <input type="radio" name="recomend" value="1">추천상품으로 등록함 &nbsp;&nbsp;
    <input type="radio" name="recomend" value="2" checked>추천상품으로 등록하지 않음&nbsp;&nbsp;
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
    <input type="radio" name="sale" value="1">세일그룹에 등록함&nbsp;&nbsp;
    <input type="radio" name="sale" value="2" checked>세일그룹에 등록하지 않음&nbsp;&nbsp;
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
	<input type=text name='rela' size="20" value='' style='text-align:right;'> 관련상품끼리 동일한 영문,숫자를 입력하세요. 
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
	<input type=text name='point' size="12" value='' >원 (이 상품을 구입함으로 발생되는 포인터가 있다면 넣으세요.) 
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	<tr>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
	<input type="radio" name="mania" value="1">매니아 포인터 채택&nbsp;&nbsp;
    <input type="radio" name="mania" value="2" checked>매니아 포인터 불채택&nbsp;&nbsp;
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
		<table align="left" border="0" cellpadding="0" cellspacing="0">
			...
			<input type="file" size="60" name="imgup1" class="input" onChange="show_pic('1','imgup1');"></font>
				...
				<td width="100">				
				<img id="pic1" width="42" height="55" src="../image/jeungm.jpg" align="absbottom" onLoad="if(this.fileSize>100000)alert('100000kbyte가 넘습니다.\n이사진은 업로드되지 않습니다.\n다시 넣어 주세요.')";>
				</td>
			</tr>
		</table>
	</td>
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
		<table align="left" border="0" cellpadding="0" cellspacing="0">
			...
			<input type="file" size="60" name="imgup2" class="input" onChange="show_pic('2','imgup2');"></font>
				...
				<td width="100">				
				<img id="pic2" width="42" height="55" src="../image/jeungm.jpg" align="absbottom" onLoad="if(this.fileSize>300000)alert('300000kbyte가 넘습니다.\n이사진은 업로드되지 않습니다.\n다시 넣어 주세요.')";>
				</td>
			</tr>
		</table>
	</td>
