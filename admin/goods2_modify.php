...
$result=mysqli_query($link,"select * from goods2 where id='$id' ");
...
function recording(fr) {
	...
	Fm.name.focus();
	return; }
	document.Form1.action = 'goods2_modify_insert.php';
...
<table align="center" border="0" cellpadding="5" cellspacing="0" width="900">
	...
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
	<input type="text" name="name" value="<?php echo $row['name']; ?>" maxlength="20" style="width:122px"> 중간 분류( ex : 한국소설, 영미소설, 일본소설)
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
	</td>
