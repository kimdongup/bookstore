...
$query=mysqli_query($link,"select * from question where id='$modifyid' ");
...
function recording(fr) {
	...
	document.Form1.action = 'questionModifyInsert.php';
...
<input type="hidden" name="mod" value="questionmodifyinsert">
...
<table align="center" border="0" cellpadding="5" cellspacing="0" width="900">
	...
	<font color="red">*</font> 실시시간
	</td>
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
    <input type="radio" name="yesno" value="y"<?php if($row['yesno']=="y"){echo "checked";} ?>>지금바로 조사시작&nbsp;&nbsp;
    <input type="radio" name="yesno" value="n"<?php if($row['yesno']=="n"){echo "checked";} ?>>나중에 조사&nbsp;&nbsp;
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
		<tr>
			<td width="155" nowrap style="padding-left:15px" class="bgc_table2" height="55">
				<font color="red">*</font> 앙케트번호
			</td>
			<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">								
				<input type="text" name="titlenum" value="<?php echo $row['titlenum']?>" maxlength="30" style="width:50px"> 이전과 같은 번호를 사용하지 마세요.
			</td>
		</tr>
		<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
		<tr>
			<td width="155" nowrap style="padding-left:15px" class="bgc_table2" height="55">
				<font color="red">*</font> 앙케트질문
			</td>
			<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">								
				<input type="text" name="atitle" value="<?php echo $row['title']?>" maxlength="30" style="width:500px">
			</td>
		</tr>
		<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
		<tr>
			<td width="155" nowrap style="padding-left:15px" class="bgc_table2" height="55">
				<font color="red">*</font> 조사 시작시간
			</td>
			<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
			<?php
			$SYear=date("Y");
			...
			?>
			<select name=Sdatey>
			<option value="2006" <?php if($SYear=="2006") echo "selected"; ?>>2006년</option>
            <option value="2007" <?php if($SYear=="2007") echo "selected"; ?>>2007년</option>
			<option value="2008" <?php if($SYear=="2008") echo "selected"; ?>>2008년</option>
			</select>
			<select name=Sdatem>
