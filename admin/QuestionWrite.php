...
function recording(fr) {
	...
	document.Form1.action = 'questionInsert.php';
...
<table align="center" border="0" cellpadding="5" cellspacing="0" width="900">
    ...
    <input type="radio" name="yesno" value="y" checked>지금바로 조사시작&nbsp;&nbsp;
    <input type="radio" name="yesno" value="n">나중에 조사&nbsp;&nbsp;
	</td>
	</tr>
	<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
		<tr>
			...
			<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">								
				<input type="text" name="titlenum" value="" maxlength="30" style="width:50px"> 이전과 같은 번호를 사용하지 마세요.
			</td>
		</tr>
		<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
		<tr>
			...
			<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">								
				<input type="text" name="atitle" value="" maxlength="30" style="width:500px">
			</td>
		</tr>
		<tr><td colspan="2" height="1" bgcolor="#dcdcdc"></td></tr>
		<tr>
