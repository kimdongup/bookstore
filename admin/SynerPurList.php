...
<td width="880"> &nbsp;<B>공동구매 상품보기</B>(총등록수 : <?php echo number_format($numrows); ?>건)
</td>
</tr>
...
$query=mysqli_query($link,"select * from synergicpurchase order by id desc limit $fromnum,$limit50");
$i=1;
...
<td align="center" bgcolor="<?php echo $bgcolor; ?>">
<?php echo number_format($row['endprice']); ?>원
</td>
<td align="center" bgcolor="<?php echo $bgcolor; ?>">
...
<td align="center" bgcolor="<?php echo $bgcolor; ?>">
<a href="SynerPurModify.php?id=<?php echo $row['id'] ?>&modifyname=<?php echo $row2['name']?>&mod=synerpurdel">수정</a> <a href="SynerPurDel.php?id=<?php echo $row['id'] ?>&delname=<?php echo $row2['name']?>&mod=synerpurdel">삭제</a>
</td>
</tr>
<tr>
