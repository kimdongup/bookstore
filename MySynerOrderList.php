...
if($my_member_id){
    ...
    $numresults=mysqli_query($link,"select id from synerorder where orderer='$my_member_id'");
...
$num=1;
$numresult=mysqli_query($link,"select * from synerorder where orderer='$my_member_id' order by id desc limit $fromnum,$limit50");
