...
if (!$synerordernum) {
	...
	$synerordernum=$timenum.$ipnum;
	$_SESSION['synerordernum'] = $synerordernum;
}
...
<p><font color=red>* 참가자가 많을 수록 현재가 계속 내려갑니다. 
<br> * 마이페이지에서 확인하세요.</font> 
</td>
</tr>
</table>
...
function recording() {
	...
	document.Form1.action = 'SynerOrderInsert.php?mod2=OrderOk';
