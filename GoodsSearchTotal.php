...
$numresults=mysqli_query($link,"select gsid from goodssc where $find like '%$search%' ");
...
// 통합검색
$query=mysqli_query($link,"select * from goodssc where $find like '%$search%' order by gsid desc limit $fromnum,$limit50");
$num=1;
while ($row=mysqli_fetch_array($query))
{
$querybody=mysqli_query($link,"select * from goods where id='$row[gsid]'");
