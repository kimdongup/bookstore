...
$numresults=mysqli_query($link,"select id from goods where gs2id='$gs2id' ");
...
<b><?php echo $name; ?></b> > 
<?php
$query=mysqli_query($link,"select id,name from goods3 where gs2id='$gs2id' ");
while ($row=mysqli_fetch_array($query)){
?>
<a href="last_group.php?name=<?php echo $name; ?>&lowname=<?php echo $row['name']; ?>&fixnum=<?php echo $fixnum; ?>&gs3id=<?php echo $row['id']; ?>">
<?php echo $row['name']; ?> |
</a>
<?php
}
...
<tr><td colspan="3" height="25" align="right">| <a href=<?php $_SERVER['SCRIPT_NAME']; ?>?name=<?php echo $name; ?>&lowname=<?php echo $lowname; ?>&gs2id=<?php echo $gs2id; ?>>기본순</a> | <a href=<?php $_SERVER['SCRIPT_NAME']; ?>?dbarray=nvolume&name=<?php echo $name; ?>&lowname=<?php echo $lowname; ?>&gs2id=<?php echo $gs2id; ?>>판매량</a> | <a href=<?php $_SERVER['SCRIPT_NAME']; ?>?dbarray=nnew&name=<?php echo $name; ?>&lowname=<?php echo $lowname; ?>&gs2id=<?php echo $gs2id; ?>>신상품</a> | <a href=<?php $_SERVER['SCRIPT_NAME']; ?>?dbarray=npricea&name=<?php echo $name; ?>&lowname=<?php echo $lowname; ?>&gs2id=<?php echo $gs2id; ?>>가격↑</a> | <a href=<?php $_SERVER['SCRIPT_NAME']; ?>?dbarray=npriced&name=<?php echo $name; ?>&lowname=<?php echo $lowname; ?>&gs2id=<?php echo $gs2id; ?>>가격↓</a> | <a href=<?php $_SERVER['SCRIPT_NAME']; ?>?dbarray=nname&name=<?php echo $name; ?>&lowname=<?php echo $lowname; ?>&gs2id=<?php echo $gs2id; ?>>상품명</a> |</td></tr>
<tr><td colspan="3" height="1" bgcolor="#cccccc"></td></tr>
...
if($dbarray=="nvolume"){
$query=mysqli_query($link,"select * from goods where gs2id='$gs2id' order by volume desc limit $fromnum,$limit50");
} else if($dbarray=="nnew"){
$query=mysqli_query($link,"select * from goods where gs2id='$gs2id' order by pmonth,pday desc limit $fromnum,$limit50");
} else if($dbarray=="npricea"){
$query=mysqli_query($link,"select * from goods where gs2id='$gs2id' order by price asc limit $fromnum,$limit50");
} else if($dbarray=="npriced"){
$query=mysqli_query($link,"select * from goods where gs2id='$gs2id' order by price desc limit $fromnum,$limit50");
} else if($dbarray=="nname"){
$query=mysqli_query($link,"select * from goods where gs2id='$gs2id' order by name desc limit $fromnum,$limit50");
} else {
$query=mysqli_query($link,"select * from goods where gs2id='$gs2id' order by id desc limit $fromnum,$limit50");
}
$num=1;
