...
if(!isset($_REQUEST['auctionordernum'])){$auctionordernum  =1;} else {$auctionordernum  = $_REQUEST['auctionordernum'];}
...
if(!isset($_REQUEST['auctionprice'])){$auctionprice  =0;} else {$auctionprice  = $_REQUEST['auctionprice'];}
...
if (!$auctionordernum) {
	...
	$auctionordernum=$timenum.$ipnum;
	$_SESSION['auctionordernum']= $auctionordernum;
}
$result=mysqli_query($link,"select * from auctionpurchase where id='$id'");
...
<td width="710"> &nbsp;<B><?php echo $my_name; ?> 님의 경매 정보</B>
</td>
</tr>
...
<td width="630" style="border-bottom-width:1; border-bottom-color:CFCADF; border-bottom-style:dotted;">
&nbsp;<?php echo number_format($row['stprice']); ?>원
</td>
</tr>
<tr>
<td width="100" height="25" align="right" style="border-bottom-width:1; border-bottom-color:CFCADF; border-bottom-style:dotted;">
...
<td width="630" style="border-bottom-width:1; border-bottom-color:CFCADF; border-bottom-style:dotted;">
&nbsp;<font color=red>
<?php echo number_format($row['price']); ?>원</b></font>
</td>
</tr>
<tr>
<td width="100" height="25" align="right" style="border-bottom-width:1; border-bottom-color:CFCADF; border-bottom-style:dotted;">
...
<td width="630" style="border-bottom-width:1; border-bottom-color:CFCADF; border-bottom-style:dotted;">
&nbsp;<font color=red>
<?php echo number_format($auctionprice); ?>원</b></font>
</td>
</tr>
<tr>
<td width="100" height="25" valign="bottom" align="right" style="border-bottom-width:1; border-bottom-color:CFCADF; border-bottom-style:dotted;">
남은시간 :
...
<!-- 
var EndDate=<?php echo $EndDate-$NowDate?>;
...
var Second = EndDate%60;
var Minute = ((EndDate-Second)/60)%60;
var Hour =((((EndDate-Second)/60)-Minute)/60)%24;
var Day = (((((EndDate-Second)/60)-Minute)/60)-Hour)/24; 

document.Form2.CountBox.value = Day+"일"+ Hour+"시간"+Minute+"분"+Second+"초"; 
...
<form name="Form2"> 
&nbsp;<input type="text" name="CountBox" size="30" style="color:red;"><br> 
</form> 
</BODY> 
</td>
</tr>
...
function recording(fr) {
	...
	document.Form1.action = 'auctionOrderInsert.php?mod2=OrderOk';
...
<input type="hidden" name="auctionprice" value="<?php echo $auctionprice?>">
...
<table align="center" border="0" cellpadding="5" cellspacing="0" width="730">
	...
	<font color="red">*</font> 경매,주문번호
	</td>
	<td width="100%" bgcolor="#fcfcfc" style="padding-left:10px">
	<b><?php echo $auctionordernum; ?></b>
	</td>
	</tr>
